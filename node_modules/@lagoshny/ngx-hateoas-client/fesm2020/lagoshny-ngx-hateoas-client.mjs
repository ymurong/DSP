...
ResourceHttpService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: ResourceHttpService, deps: [{ token: i1.HttpClient }, { token: ResourceCacheService }], target: i0.ɵɵFactoryTarget.Injectable });
...
ResourceCollectionHttpService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: ResourceCollectionHttpService, deps: [{ token: i1.HttpClient }, { token: ResourceCacheService }], target: i0.ɵɵFactoryTarget.Injectable });
...
PagedResourceCollectionHttpService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: PagedResourceCollectionHttpService, deps: [{ token: i1.HttpClient }, { token: ResourceCacheService }], target: i0.ɵɵFactoryTarget.Injectable });
...
CommonResourceHttpService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: CommonResourceHttpService, deps: [{ token: i1.HttpClient }, { token: ResourceCacheService }], target: i0.ɵɵFactoryTarget.Injectable });
...
HateoasResourceService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: HateoasResourceService, deps: [{ token: CommonResourceHttpService }, { token: ResourceHttpService }, { token: ResourceCollectionHttpService }, { token: PagedResourceCollectionHttpService }, { token: ResourceCacheService }], target: i0.ɵɵFactoryTarget.Injectable });
...
NgxHateoasClientModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: NgxHateoasClientModule, deps: [{ token: NgxHateoasClientConfigurationService }], target: i0.ɵɵFactoryTarget.NgModule });
