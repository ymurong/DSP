...
export declare const RESOURCE_NAME_PROP = "__resourceName__";
export declare const RESOURCE_OPTIONS_PROP = "__options__";
/**
...
declare type NonResourcePropertyType<T> = {
 ...
 */
export declare type ProjectionRelType<T extends BaseResource> = Pick<T, Exclude<keyof T, keyof Resource | keyof EmbeddedResource> & NonResourcePropertyType<T>>;
/**
